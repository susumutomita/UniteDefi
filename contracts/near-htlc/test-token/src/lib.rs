...
impl TestToken {
    #[init]
    pub fn new(total_supply: U128, _metadata: FungibleTokenMetadata) -> Self {
        let mut token = Self {
        ...
        token
            .balances
            .insert(&env::predecessor_account_id(), &total_supply.0);
    ...
    pub fn storage_deposit(&mut self, account_id: Option<AccountId>) -> U128 {
        ...
        U128(env::attached_deposit().as_yoctonear())
    }
}
